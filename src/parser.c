...
#line 159 "src/parser.c" /* yacc.c:339  */
...
union YYSTYPE {
#line 96 "src/parser.y" /* yacc.c:355  */
...
static const yytype_uint8 yytranslate[] = {
    ...
    2, 2, 2, 2, 2, 2,  2, 2, 2, 13, 2, 2, 14, 2, 2, 2, 2, 2, 11, 2, 12, 2, 2, 2,
    2, 2, 2, 2, 2, 2,  2, 2, 2, 2,  2, 7, 2,  8, 2, 2, 2, 2, 2,  2, 2,  2, 2, 2,
    2, 2, 2, 2, 2, 2,  2, 2, 2, 2,  2, 2, 2,  2, 2, 2, 2, 2, 2,  2, 2,  2, 2, 2,
    2, 2, 2, 2, 2, 2,  2, 2, 2, 2,  2, 2, 2,  2, 2, 2, 2, 2, 2,  2, 2,  2, 2, 2,
    2, 2, 2, 9, 2, 10, 2, 2, 2, 2,  2, 2, 2,  2, 2, 2, 2, 2, 2,  2, 2,  2, 2, 2,
    2, 2, 2, 2, 2, 2,  2, 2, 2, 2,  2, 2, 2,  2, 2, 2, 2, 2, 2,  2, 2,  2, 2, 2,
    2, 2, 2, 2, 2, 2,  2, 2, 2, 2,  2, 2, 2,  2, 2, 2, 2, 2, 2,  2, 2,  2, 2, 2,
    2, 2, 2, 2, 2, 2,  2, 2, 2, 2,  2, 2, 2,  2, 2, 2, 2, 2, 2,  2, 2,  2, 2, 2,
    2, 2, 2, 2, 2, 2,  2, 2, 2, 2,  2, 2, 2,  2, 2, 2, 2, 2, 2,  2, 2,  2, 2, 2,
...
static const yytype_uint8 yyrline[] = {
    0,   118, 118, 119, 123, 124, 125, 126, 130, 139, 151,
    163, 178, 179, 183, 184, 188, 189, 193, 202, 211, 224,
    225, 229, 230, 234, 235, 239, 240, 244, 245, 251, 252};
#endif
...
static const yytype_uint16 yytoknum[] = {0,  256, 257, 258, 259, 260, 261, 59,
                                         61, 123, 125, 42,  44,  33,  36};
#endif
...
static const yytype_int8 yypact[] = {
    17,  25, 18,  21,  17,  -34, -34, -7,  -34, -34, -34, 32, 28,  22,
    -34, 36, -34, -34, -34, 41,  42,  -34, 35,  -34, -34, 22, -34, 39,
    44,  6,  44,  40,  43,  44,  -34, -1,  -34, 35,  45,  35, 22,  -34,
    37,  44, 47,  44,  49,  -34, 22,  48,  -34, 50,  -34, 5,  22,  22,
    -34, 35, 52,  54,  44,  -34, -34, 53,  22,  55,  -34};

/* YYDEFACT[STATE-NUM] -- Default reduction number in state STATE-NUM.
   Performed when YYTABLE does not specify something else to do.  Zero
   means the default is an error.  */
static const yytype_uint8 yydefact[] = {
    3,  22, 0,  0,  2,  7,  6,  0,  31, 29, 32, 0,  0, 25, 28, 0, 1,
    5,  4,  0,  0,  30, 13, 27, 8,  26, 21, 0,  15, 0, 15, 22, 0, 14,
    17, 0,  11, 13, 0,  13, 26, 16, 24, 15, 0,  15, 0, 23, 0,  0, 12,
    0,  10, 0,  26, 26, 18, 13, 0,  0,  15, 9,  20, 0, 26, 0,  19};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] = {-34, -34, -34, 60,  61,  -33, -27,
                                      -34, 19,  38,  -34, -23, 3,   -13};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] = {-1, 3,  4,  5,  6,  28, 32,
                                        33, 34, 35, 48, 12, 13, 14};

/* YYTABLE[YYPACT[STATE-NUM]] -- What to do in state STATE-NUM.  If
   positive, shift that token.  If negative, reduce the rule whose
   number is the opposite.  If YYTABLE_NINF, syntax error.  */
static const yytype_int8 yytable[] = {
    23,  19, 29, 38, 43, 20, 45, 42, 8,  9,  10, 20, 56, 36, 57, 37, 49,
    46,  51, 11, 1,  16, 15, 2,  60, 8,  9,  10, 8,  9,  10, 58, 59, 63,
    -26, 21, 11, 22, 7,  11, 23, 65, 7,  24, 25, 26, 27, 31, 30, 39, 47,
    53,  41, 40, 50, 44, 52, 0,  54, 61, 55, 62, 66, 64, 17, 18};

static const yytype_int8 yycheck[] = {
    13, 8,  25, 30, 37, 12, 39, 8,  3, 4,  5, 12, 7,  7, 9,  9,  43,
    40, 45, 14, 3,  0,  4,  6,  57, 3, 4,  5, 3,  4,  5, 54, 55, 60,
    9,  3,  14, 9,  0,  14, 53, 64, 4, 7,  3, 3,  11, 3, 9,  9,  13,
    48, 33, 10, 7,  10, 7,  -1, 10, 7, 10, 7, 7,  10, 4, 4};

/* YYSTOS[STATE-NUM] -- The (internal number of the) accessing
   symbol of state STATE-NUM.  */
static const yytype_uint8 yystos[] = {
    0,  3,  6,  16, 17, 18, 19, 24, 3,  4,  5,  14, 26, 27, 28, 4,  0,
    18, 19, 8,  12, 3,  9,  28, 7,  3,  3,  11, 20, 26, 9,  3,  21, 22,
    23, 24, 7,  9,  21, 9,  10, 23, 8,  20, 10, 20, 26, 13, 25, 21, 7,
    21, 7,  27, 10, 10, 7,  9,  26, 26, 20, 7,  7,  21, 10, 26, 7};

/* YYR1[YYN] -- Symbol number of symbol that rule YYN derives.  */
static const yytype_uint8 yyr1[] = {0,  15, 16, 16, 17, 17, 17, 17, 18, 19, 19,
                                    19, 20, 20, 21, 21, 22, 22, 23, 23, 23, 24,
                                    24, 25, 25, 26, 26, 27, 27, 28, 28, 28, 28};

/* YYR2[YYN] -- Number of symbols on the right hand side of rule YYN.  */
static const yytype_uint8 yyr2[] = {0, 2, 1, 0, 2, 2, 1, 1, 3,  10, 8,
                                    5, 5, 0, 1, 0, 2, 1, 5, 10, 7,  3,
                                    1, 1, 0, 1, 0, 2, 1, 1, 2,  1,  1};
...
#define YY_SYMBOL_PRINT(Title, Type, Value, Location)                          \
  do {                                                                         \
    if (yydebug) {                                                             \
      ...
      yy_symbol_print(stderr, Type, Value, commands);                          \
      YYFPRINTF(stderr, "\n");                                                 \
    }                                                                          \
  } while (0)
...
#line 130 "src/parser.y" /* yacc.c:1646  */
  {
    if (!(is_dir((yyvsp[-1].str)) ? config_pushdir((yyvsp[-1].str))
                                  : config_pushfile((yyvsp[-1].str)))) {
...
#line 1373 "src/parser.c" /* yacc.c:1646  */
  break;
...
#line 1407 "src/parser.c" /* yacc.c:1646  */
  break;
...
#line 188 "src/parser.y" /* yacc.c:1646  */
  {
    (yyval.alias_list) =
        alias_list_append((yyvsp[-1].alias_list), (yyvsp[0].alias));
  }
...
#line 1457 "src/parser.c" /* yacc.c:1646  */
  break;
...
#line 211 "src/parser.y" /* yacc.c:1646  */
  {
    ...
    (yyval.alias)->substitutes =
        string_list_append(NULL, strdup((yyvsp[-6].str)));
    (yyval.alias)->substitutes_after = (yyvsp[-1].str_list);
    (yyval.alias)->global_alias_list = (yyvsp[-4].alias_list);
    (yyval.alias)->sub_alias_list = (yyvsp[-3].alias_list);
  }
...
#undef YYSYNTAX_ERROR
  ...
  if (yyerrstatus == 3) {
    ...
    if (yychar <= YYEOF) {
      ...
      yydestruct("Error: discarding", yytoken, &yylval, commands);
      yychar = YYEMPTY;
    }
  }
...
yyerrlab1:
  ...
  for (;;) {
    ...
    yydestruct("Error: popping", yystos[yystate], yyvsp, commands);
    YYPOPSTACK(1);
    yystate = *yyssp;
    YY_STACK_PRINT(yyss, yyssp);
  }
...
yyreturn:
  if (yychar != YYEMPTY) {
    /* Make sure we have latest lookahead translation.  See comments at
       user semantic actions for why this is necessary.  */
    yytoken = YYTRANSLATE(yychar);
    yydestruct("Cleanup: discarding lookahead", yytoken, &yylval, commands);
  }
  /* Do not reclaim the symbols of the rule whose action triggered
  ...
  YY_STACK_PRINT(yyss, yyssp);
  while (yyssp != yyss) {
    yydestruct("Cleanup: popping", yystos[*yyssp], yyvsp, commands);
    YYPOPSTACK(1);
  }
#ifndef yyoverflow
  if (yyss != yyssa)
...
#line 274 "src/parser.y" /* yacc.c:1906  */
